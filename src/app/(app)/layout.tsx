  ...
  const sidebar = (
    <div className="flex h-full flex-col">
      ...
      <div className="mt-4 border-t border-slate-200 pt-4 dark:border-slate-800">
        <Link
          href="/profile"
          className="flex items-center gap-3 rounded-lg px-1 py-1.5 transition hover:bg-slate-100 dark:hover:bg-slate-800"
        >
        ...
        <Button onClick={handleLogout} block className="mt-3">
          Log out
        </Button>
      </div>
    </div>
